...
This guide demonstrates the complete service delivery workflow through two user perspectives: requesting services through the catalog and managing them through Infrahub. You'll see how automated provisioning transforms simple requests into fully configured network services.
...
3. **Fill Out the Service Request Form**
   ...
   - **Service Identifier**: Choose a unique name (e.g., "DI-DEMO-001")
